...
const API_URL = "http://processor-service:5001/process-videos";
const INVERTED_INDEX_URL = "http://inverted-index-service:5002";
const S3_BUCKET_URL = "http://my-s3-bucket-service";
